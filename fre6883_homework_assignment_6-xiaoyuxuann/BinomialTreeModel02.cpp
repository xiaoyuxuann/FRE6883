...
namespace fre {
    ...
    int BinomialTreeModel::GetInputData() {
        //entering data
        cout << "Enter S0: "; cin >> S0; cout << "Enter U: "; cin >> U; cout << "Enter D: "; cin >> D; cout << "Enter R: "; cin >> R; cout << endl;
        ...
        if (R>=U || R<=D)
        {
            ...
            cout << "Terminating program" << endl; return -1;
        }
    ...
    {
        cout << "Illegal data ranges" << endl; cout << "Terminating program" << endl; return -1;
    }
    //checking for arbitrage 
    if (R >= U || U <= D)
    {
